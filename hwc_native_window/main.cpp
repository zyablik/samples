...
int main(int, char **) {
    ...
    HWCNativeWindow * hwc_window = new HWCNativeWindow(1080, 1920);
    EGLint window_attribs[] = { EGL_NONE };
    EGLSurface offscreen_egl_surface = eglCreateWindowSurface(egl_display, egl_config, hwc_window, window_attribs);
