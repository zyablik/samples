...
//    egl_display = eglGetDisplay(gbm_dev);
    ...
    static const char pointVertexShaderStr[] =
        "void main() {\n"
            "  gl_Position = vec4(0.0, 0.0, 0.0, 1.0);\n"
            "  gl_PointSize = 10.0;\n"
        "}\n";

    static const char pointFragmentShaderStr[] =
        "void main() {\n"
            "gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0);\n"
        "}\n";

    GLuint pointProgram = createProgram(pointVertexShaderStr, pointFragmentShaderStr);
